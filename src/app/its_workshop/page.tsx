        ...
        <div className="row">
          <div className="col-md-9 page-content">
            <div className="well well-white">
              <h1 className="page-title" style={{ borderBottom: '1px solid #eee', paddingBottom: '10px', marginBottom: '20px' }}>Workshop on Intelligent Transportation Systems (ITS)</h1>
              <p className="text-center" style={{ padding: '40px 20px', fontSize: '18px', color: '#64748b' }}>
                The Workshop on Intelligent Transportation Systems (ITS) at COMSNETS 2027 will be announced soon. Stay tuned for updates.
              </p>
