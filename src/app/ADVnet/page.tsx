          ...
          <div className="event-section">
            ...
            <div className="topic-grid">
              ...
              <div className="topic-cat">
                <h4><i className="fa fa-wifi" aria-hidden="true"></i>Infrastructure, Connectivity, and Communications for CAVs</h4>
                <ul>
              ...
              <div className="topic-cat">
                <h4><i className="fa fa-eye" aria-hidden="true"></i>Sensing, Perception, and Cyber-Physical Architectures</h4>
                <ul>
              ...
              <div className="topic-cat">
                <h4><i className="fa fa-cogs" aria-hidden="true"></i>Vehicle Automation, Control, Testing and Validation</h4>
                <ul>
              ...
              <div className="topic-cat">
                <h4><i className="fa fa-shield" aria-hidden="true"></i>Safety, Security, and Human-Machine Interaction</h4>
                <ul>
              ...
              <div className="topic-cat">
                <h4><i className="fa fa-balance-scale" aria-hidden="true"></i>Policy, Ethics and Emerging Mobility Paradigms</h4>
                <ul>
