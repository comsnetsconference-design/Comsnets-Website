            ...
            <div className="container" style={{ marginTop: '30px', marginBottom: '40px' }}>
                <div className="event-page">
                    ...
                    <div className="event-hero">
                        <h1>Workshop on Standards-driven Research (SDR)</h1>
                        <p className="lead">THEME: "Marching towards 6G"</p>
                        <div className="event-details">COMSNETS 2027</div>
                    </div>

                    <div className="event-section">
                        <h3 className="section-title">Context & Rationale</h3>
                        <p className="text-justify">SDR Workshop is structured as an annual event for a multi-faceted global community (academics, industry, government) organized around <strong>Telecom <u>standards</u> (nominally oriented to 6G).</strong> The workshop brings together members of this diverse community to deliberate and collaborate across the FULL life cycle of Standardisation – from Pre-Standardisation activities to Standards Development and Post-Standardisation. The ability to innovate in, contribute to and adopt leading-edge globally relevant Technical Specifications or Industry standards for Telecom and networking is of paramount significance to the nation's industrial capacity and ultimate societal well-being.</p>
                        <p className="text-justify">This implies that workshop topics be linked in some manner to current global (e.g. ITU, 3GPP, IEEE, ISO/IEC) Standards Development Organisation's (SDOs) Technology Working Group's (WG) deliberations or to future (6G) standards development roadmaps (e.g 3GPP Rel-19 and beyond). Further, contributions that summarize experiences and provide insights into strategic issues around the IP creation pipeline for various global/national SDO WGs are also welcome. Finally, the workshop particularly invites submissions that highlight aspects of telecom standardization relevant for India specific use cases and national research priorities, in view of Bharat 6G vision.</p>
                        <h5>Summary:</h5>
                    ...
                    <div className="event-section">
                        <h3 className="section-title">Call for Contributions</h3>
                    ...
                    <div className="event-section">
                        ...
                        <div className="topic-grid">
                            ...
                            <div className="topic-cat">
                                <h4><i className="fa fa-flask" aria-hidden="true"></i>Pre-Standards Topics</h4>
                                <ul>
                            ...
                            <div className="topic-cat">
                                <h4><i className="fa fa-rocket" aria-hidden="true"></i>Emerging Technology Areas</h4>
                                <ul>
                            ...
                            <div className="topic-cat">
                                <h4><i className="fa fa-cogs" aria-hidden="true"></i>Post-Standardisation Topics</h4>
                                <ul>
                    ...
                    <div className="event-section">
                        <h3 className="section-title">How is a Contribution different from a paper?</h3>
                        <ul>
                    ...
                    <div className="event-section">
                        ...
                        <ul>
                            <li>Submissions (including title, author list, abstract, all figures, tables, and references) should <strong>not exceed 6 pages</strong> in length including all references. A <strong>minimum number of 4 pages</strong> are required. The Abstract, Introduction & References should clearly indicate the relevant standards or feature(s) analyzed and include URLs to appropriate standards reports/documents or relevant industry sources.</li>
                            <li>Reviews will be <strong>single-blind:</strong> authors name and affiliation should be included in the submission.</li>
                            <li>Submissions must follow the formatting guidelines as given on COMSNETS Website; those that do not meet the size and formatting requirements will not be reviewed</li>
